...
def results(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print   '\033[0;97m┌'+48*'─'+ '┐'
        print   '├        \033[0;97m├'+31*'─'+ '┐       ┤'
        print("\033[0;97m├        |🌹Thanks For Using Zmbf.     🌹|       ┤")
        print("\033[0;97m├        |🌹Remember Me In Your Prayers🌹|       ┤")
        print("\033[0;97m├        |🌹Khuda Hafiz.               🌹|       ┤")
        print   '├        \033[0;97m└'+31*'─'+ '┘       ┤'
        print   '\033[0;97m└'+48*'─'+ '┘'
...
def login():
	...
	try:
		...
		print("├             └────────────────────┘             ┤")
		print   '├     \033[0;97m├'+35*'─'+ '┐      ┤'
		print("\033[0;97m├     |🌹Author Name: Zahid Mahmood     🌹|      ┤")
		print("\033[0;97m├     |🌹GitHub     : github.com\ZKWorld🌹|      ┤")
		print("\033[0;97m├     |🌹YouTube    : Zee K World       🌹|      ┤")
		print("\033[0;97m├     |🌹TeleGram   : t.me\ZeeKWorld    🌹|      ┤")
		print   '├     \033[0;97m└'+35*'─'+ '┘      ┤'
		print   '\033[0;97m└'+48*'─'+ '┘'
	zk = raw_input("\n  \033[0;97m[\033[0;92m➣\033[0;97m] Type ZK/zk To Enter The ZMBF: ")
	if zk =="":
...
def cracking_menu():
	...
	print("├ [06] Subscribe My YouTube Channel              ┤")
	print("├ [07] Join My TeleGram Group                    ┤")
	print("├ [08] Like My FaceBook Page                     ┤")
	print("├ [09] Logout From Facebook                      ┤")
